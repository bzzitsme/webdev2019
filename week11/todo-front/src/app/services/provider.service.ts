...
export class ProviderService extends MainService {
  ...
  deleteTaskList(taskList: TaskList) {
    return this.delete('http://localhost:8000/api/task_lists/' + taskList.id, {});
  }
  ...
  deleteTask(task: Task) {
    ...
    return this.delete('http://localhost:8000/api/task_lists/' + task.task_list.id + '/tasks/' + task.id, {});
  }
}